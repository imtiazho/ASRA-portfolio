    ...
    return (
        <div className='sticky top-12 border border-[#565656] bottom-0 right-0 left-0 flex flex-col gap-6 p-6 rounded-[27px]'>
            ...
            <div className="flex justify-center gap-2">
                ...
                <a className='w-[40px] h-[40px] rounded-full border flex justify-center items-center border-[#565656] text-[#565656] hover:text-primary hover:border-primary duration-300' href='https://www.instagram.com/imtiazhoo/' target='_blank' rel="noreferrer"><i class="fa-brands fa-square-instagram"></i></a>
                <a className='w-[40px] h-[40px] rounded-full border flex justify-center items-center border-[#565656] text-[#565656] hover:text-primary hover:border-primary duration-300' href='https://github.com/imtiazho' target='_blank' rel="noreferrer"><i class="fa-brands fa-square-behance"></i></a>
            </div>
